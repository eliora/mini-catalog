 ...
 * 
 * @param {string} title - Display title for the filter section
 * @param {Array} options - Available options to select from
 * @param {Array} selectedValues - Currently selected values
 * @param {Function} onChange - Callback when selection changes
 * @param {boolean} disabled - Whether the filter is disabled
 * @param {Function} getDisplayText - Optional function to transform display text
 */
