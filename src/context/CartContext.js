...
export function CartProvider({ children }) {
  ...
  const value = useMemo(() => ({ cart, addToCart, updateQuantity, removeFromCart, clearCart, getCartItemCount }), [cart, addToCart, updateQuantity, removeFromCart, clearCart, getCartItemCount]);
