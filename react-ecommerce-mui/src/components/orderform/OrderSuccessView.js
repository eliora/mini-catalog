 ...
 * 
 * @param {Object} orderSummary - Order data (orderId, customerName, items, totals)
 * @param {Function} formatCurrency - Currency formatting function
 * @param {Function} onNewOrder - Callback for starting a new order
 * @param {React.Ref} printRef - Ref for print functionality
 */
...
const OrderSuccessView = forwardRef(({ 
  orderSummary, 
  formatCurrency, 
  onNewOrder 
}, ref) => {
