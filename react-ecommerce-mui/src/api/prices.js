 ...
 * @returns {Promise<Object>} - Prices keyed by product ref
 */
export const getPrices = async (productRefs = null) => {
  try {
    let query = supabase
      .from('prices')
      .select(`
 ...
 * @returns {Promise<Object|null>} - Price object or null if not accessible
 */
export const getPrice = async (productRef) => {
 ...
 */
export const canViewPrices = async () => {
  try {
 ...
 */
export const updatePrice = async (productRef, unitPrice, options = {}) => {
  try {
    const updateData = {
 ...
 */
export const deletePrice = async (productRef) => {
  try {
